    ...
    render() {
        return (
            <div className="Navbar_row row  py-2 mb-5">
                <div className={`${this.props.starter ? 'navbar_c navlist_custom_styling' : 'navbar_c'}`}>
                    <div className="nav-header">
                        <Link to="/">
                           {this.props.starter?<> <img src={logo_N} className="d-block d-md-none" alt="Sumurai" width="160px"/>  <img src={logo_white} className="d-none d-md-block" alt="Sumurai" width="160px"/> </>: <img  className="" src={logo_N} alt="Sumurai" />}
                        </Link>
                        <button type="button" className="nav-btn" onClick={this.handleToggle}>
                            <FontAwesomeIcon icon={faAlignRight}/>
                        </button>
                    </div>
                    <ul className={this.state.isOpen?`nav-links show-nav`:`nav-links my-auto set_margin_right ` }>
                        <li>
                            <Link to="/">
                                Home
                            </Link>
                        ...
                        <Dropdown>
                            <Dropdown.Toggle className='px-2 m-0 bg-transparent' id="Projects">
